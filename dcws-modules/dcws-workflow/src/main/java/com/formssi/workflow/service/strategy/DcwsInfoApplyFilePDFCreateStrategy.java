...
public class DcwsInfoApplyFilePDFCreateStrategy implements DcwsApplyFilePDFCreateStrategy<TaskNodeDataVo> {
    @Autowired
    ...
    public Map<String, Object> process(String templateName,TaskNodeDataVo taskNodeDataVo) {
        ...
        try {
            ...
            data.put("applyContentType",taskNodeDataVo.getApplyContentType());//资料类型
            data.put("status","已完成");//当前环节 TODO
            data.put("applyReson",taskNodeDataVo.getApplyReson());//申请内容
