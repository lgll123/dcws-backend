package com.formssi.dashboard.core.module.template.controller;
...
import com.formssi.dashboard.core.module.template.dto.PageTemplateDTO;
import com.formssi.dashboard.core.module.template.dto.PageTemplateSearchDTO;
...
import com.formssi.dashboard.core.module.template.vo.PageTemplateVO;
 ...
 */
@RestController("dashboardPageTemplateController")
    ...
    public R<PageVO<PageTemplateVO>> getPage(@ApiParam(name = "查询", value = "传入查询的业务条件", required = true) PageTemplateSearchDTO searchDTO) {
        ...
        PageVO<PageTemplateVO> pageVO = BeanConvertUtils.convertPage(page, PageTemplateVO.class, (source, target) -> {
            ...
            if (target.getThumbnail() != null && !target.getThumbnail().startsWith("http")) {
                target.setThumbnail(dashboardConfig.getFile().getUrlPrefix() + target.getThumbnail());
            }
        });
