...
import com.formssi.system.domain.dto.ModuleEnvironmentDTO;
import lombok.Data;
...
public class DocInfoSaveBo {
    ...
    private List<DocParamSaveBo> pathParams;
    private List<DocParamSaveBo> headerParams;
    private List<DocParamSaveBo> queryParams;
    private List<DocParamSaveBo> requestParams;
    private List<DocParamSaveBo> responseParams;
    private List<DocParamSaveBo> errorCodeParams;

    private List<DocParamSaveBo> globalHeaders;
    private List<DocParamSaveBo> globalParams;
    private List<DocParamSaveBo> globalReturns;
}
