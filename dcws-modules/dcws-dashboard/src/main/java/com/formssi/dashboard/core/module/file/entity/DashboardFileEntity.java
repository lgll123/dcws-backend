package com.formssi.dashboard.core.module.file.entity;
...
@TableName("dashboard_file")
@ApiModel
@ToString(callSuper = true)
public class DashboardFileEntity extends SuperEntity implements Serializable {
