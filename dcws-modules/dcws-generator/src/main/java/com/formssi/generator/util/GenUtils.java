...
import com.formssi.generator.config.GenConfig;
...
public class GenUtils {
     ...
     * 初始化表信息
     */
    public static void initTable(DmTable dmTable, Long operId) {
        dmTable.setClassName(convertClassName(dmTable.getTableName()));
        dmTable.setPackageName(GenConfig.getPackageName());
        dmTable.setModuleName(getModuleName(GenConfig.getPackageName()));
        dmTable.setBusinessName(getBusinessName(dmTable.getTableName()));
        dmTable.setFunctionName(replaceText(dmTable.getTableComment()));
        dmTable.setFunctionAuthor(GenConfig.getAuthor());
        dmTable.setCreateBy(operId);
    }

    /**
     * 初始化列属性字段
     */
    public static void initColumnField(DmTableColumn column, DmTable table) {
