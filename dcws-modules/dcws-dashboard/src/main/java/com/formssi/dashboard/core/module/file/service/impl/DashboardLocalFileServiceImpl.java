package com.formssi.dashboard.core.module.file.service.impl;

import com.baomidou.mybatisplus.core.toolkit.IdWorker;
import com.formssi.common.exception.GlobalException;
import com.formssi.dashboard.core.config.DashboardConfig;
import com.formssi.dashboard.core.config.bean.FileConfig;
import com.formssi.dashboard.core.module.file.entity.DashboardFileEntity;
import com.formssi.dashboard.core.module.file.service.IDashboardFileService;
import com.formssi.dashboard.core.module.file.service.IDashboardOssService;
...
public class DashboardLocalFileServiceImpl implements IDashboardOssService {
    ...
    public DashboardFileEntity upload(MultipartFile file, DashboardFileEntity fileEntity, HttpServletResponse response, HttpServletRequest request) {
        ...
        FileConfig fileConfig = dashboardConfig.getFile();
    ...
    public void download(String fileId, HttpServletResponse response, HttpServletRequest request) {
        DashboardFileEntity fileEntity = sysFileService.getById(fileId);
        if (fileEntity == null) {
