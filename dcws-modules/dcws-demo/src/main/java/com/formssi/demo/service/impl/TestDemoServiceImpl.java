package com.formssi.demo.service.impl;
...
import com.formssi.demo.domain.bo.TestDemoBo;
import com.formssi.demo.domain.vo.TestDemoVo;
import com.formssi.demo.mapper.TestDemoMapper;
import com.formssi.demo.service.ITestDemoService;
...
public class TestDemoServiceImpl implements ITestDemoService {
    ...
    private LambdaQueryWrapper<TestDemo> buildQueryWrapper(TestDemoBo bo) {
        ...
        lqw.in(CollectionUtils.isNotEmpty(bo.getIdList()), TestDemo::getId, bo.getIdList());
        lqw.between(params.get("beginCreateTime") != null && params.get("endCreateTime") != null,
            TestDemo::getCreateTime, params.get("beginCreateTime"), params.get("endCreateTime"));
//        lqw.orderByAsc(TestDemo::getId);
        lqw.orderByDesc(TestDemo::getCreateTime);
        return lqw;
    }
