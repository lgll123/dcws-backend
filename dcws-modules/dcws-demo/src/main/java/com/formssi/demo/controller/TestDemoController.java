...
import com.formssi.common.excel.core.ExcelResult;
...
import com.formssi.demo.domain.bo.TestDemoImportVo;
...
public class TestDemoController extends BaseController {
    ...
    public R<Void> importData(@RequestPart("file") MultipartFile file) throws Exception {
        ...
        List<TestDemo> list = CopyUtil.copyList(excelResult.getList(), TestDemo::new);
