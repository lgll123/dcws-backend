...
import com.formssi.workflow.common.enums.FormTypeEnum;
import org.springframework.stereotype.Service;
import com.formssi.workflow.domain.bo.WfFormManageBo;
import com.formssi.workflow.domain.vo.WfFormManageVo;
import com.formssi.workflow.domain.WfFormManage;
import com.formssi.workflow.mapper.WfFormManageMapper;
...
public class WfFormManageServiceImpl implements IWfFormManageService {
    ...
    @Override
    public WfFormManageVo queryByRouter(String router) {
        return baseMapper.selectVoOne(new LambdaQueryWrapper<WfFormManage>().eq(WfFormManage::getRouter, router));
    }
