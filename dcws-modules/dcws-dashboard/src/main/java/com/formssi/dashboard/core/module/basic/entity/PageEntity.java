package com.formssi.dashboard.core.module.basic.entity;
...
import com.formssi.dashboard.core.module.basic.entity.type.BasePageDTOTypeHandler;
 ...
 */
@Data
@TableName(value = "dashboard_page", autoResultMap = true)
@ApiModel
