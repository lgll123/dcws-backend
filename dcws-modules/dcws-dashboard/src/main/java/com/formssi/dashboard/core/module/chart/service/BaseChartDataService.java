package com.formssi.dashboard.core.module.chart.service;

import com.formssi.dashboard.core.constant.PageDesignConstant;
import com.formssi.dashboard.core.module.chart.bean.Chart;
import com.formssi.dashboard.core.module.chart.bean.Filter;
import com.formssi.dashboard.core.module.chart.components.datasource.BaseChartDataSource;
import com.formssi.dashboard.core.module.chart.components.datasource.DataSetDataSource;
import com.formssi.dashboard.core.module.chart.dto.ChartDataSearchDTO;
import com.formssi.dashboard.core.module.chart.vo.ChartDataVO;
import com.formssi.common.exception.GlobalException;
import com.formssi.common.utils.JSON;
import com.formssi.common.vo.PageVO;
import com.formssi.dataset.constant.DatasetConstant;
import com.formssi.dataset.dto.DatasetParamDTO;
import com.formssi.dataset.entity.DatasetEntity;
import com.formssi.dataset.entity.config.JsonDataSetConfig;
import com.formssi.dataset.params.ParamsClient;
import com.formssi.dataset.service.IBaseDataSetService;
import com.formssi.dataset.service.factory.DataSetServiceFactory;
import com.formssi.dataset.vo.DatasetInfoVO;
...
public class BaseChartDataService {
    ...
    private ChartDataVO dataSetDataQuery(DataSetDataSource dataSource, Chart chart, ChartDataSearchDTO searchDTO, IBaseDataSetService dataSetService) {
        ...
        if (chart.getType().equals(PageDesignConstant.DashBoard.Type.TABLES)) {
